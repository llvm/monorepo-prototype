...
; CHECK:       [[MIDDLE_HEADER]]:
; CHECK-NEXT:    [[INDVAR_MIDDLE:%.*]] = phi i64 [ 4, %[[OUTERMOST_HEADER]] ], [ [[INDVAR_MIDDLE_NEXT:%.*]], %[[MIDDLE_LATCH:.*]] ]
; CHECK-NEXT:    br i1 [[TOBOOL71_I]], label %[[INNERMOST_PREHEADER:.*]], label %[[MIDDLE_LATCH]]
; CHECK:       [[INNERMOST_PREHEADER]]:
; CHECK-NEXT:    br label %[[INNERMOST_BODY:.*]]
; CHECK:       [[INNERMOST_BODY]]:
; CHECK-NEXT:    [[INDVAR_INNERMOST:%.*]] = phi i64 [ [[TMP1:%.*]], %[[INNERMOST_BODY]] ], [ 4, %[[INNERMOST_PREHEADER]] ]
...
; CHECK-NEXT:    br i1 [[TMP2]], label %[[INNERMOST_LOOPEXIT:.*]], label %[[INNERMOST_BODY]]
...
; CHECK-NEXT:    br i1 [[TOBOOL2_I]], label %[[OUTERMOST_LATCH]], label %[[MIDDLE_HEADER]]
