...
; CHECK:       # %bb.0: # %bb
; CHECK-NEXT:    movq $-8192, %rax # imm = 0xE000
; CHECK-NEXT:    vpmovsxbq {{.*#+}} ymm0 = [2,2,2,2]
; CHECK-NEXT:    .p2align 4
